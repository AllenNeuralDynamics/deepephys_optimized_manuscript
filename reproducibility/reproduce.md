...
PCGrad row as the sole exclusion. Both sorter benchmarks are complete.
...
`db76c533-9f39-46e6-98fe-e83adf56ea51` succeeded and reused the eligible
upstream caches. Final metrics and the exact raw-arm identity audit are in
